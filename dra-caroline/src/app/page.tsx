...
import CTASection from "@/components/ctaFinal";
...
export default function Home() {
  return (
    <main>
      ...
      <AboutSection
        imageSrc="/hero.png"
        imageAlt="Dra. Caroline sorrindo, vestindo jaleco branco, com estetoscopio no pescoço, em um ambiente de consultorio medico bem iluminado."
        title="Conheça a Dra. Caroline Tomas"
        paragraphs={[
          "Com uma carreira dedicada a gastroenterologia e hepatologia, a Dra. Caroline Tomas se destaca por sua abordagem humanizada e centrada no paciente. Ela possui uma vasta experiência em diagnóstico e tratamento de condições gastrointestinais, com foco especial em doenças hepáticas.",
          "A Dra. Caroline é reconhecida por sua habilidade em combinar conhecimento científico rigoroso com uma comunicação clara e empática, garantindo que cada paciente se sinta ouvido e compreendido. Seu compromisso é oferecer um atendimento personalizado, adaptado às necessidades individuais de cada pessoa.",
          "Além de seu trabalho clínico, a Dra. Caroline é ativa na comunidade médica, participando de congressos e contribuindo para pesquisas na área de gastroenterologia. Ela acredita que a saúde digestiva é fundamental para o bem-estar geral e se dedica a ajudar seus pacientes a alcançar uma vida mais saudável e equilibrada.",
        ]}
      />
      ...
      <CTASection
        ...
        paragraphs={["Sua rotina é intensa, mas o seu corpo não pode esperar.",
          "O cuidado preventivo é o caminho mais seguro para garantir bem-estar e qualidade de vida a longo prazo.",
          "Estamos preparados para oferecer o atendimento técnico, humano e acolhedor que sua saúde digestiva merece.",
          "Agende sua avaliação e priorize o que é essencial: a sua saúde."
        ]}
        ctaLabel="Comece a se cuidar agora"
      />
